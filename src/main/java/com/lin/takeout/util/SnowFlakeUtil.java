...
public class SnowFlakeUtil {
    ...
    private final static long DATACENTER_BIT = 6; // 机房id占用位数

    // 每部分最大值
    private final static long MAX_DATACENTER_NUM = -1L ^ (-1L << DATACENTER_BIT);//-1L ^ (-1L << 6)
    private final static long MAX_MACHINE_NUM = -1L ^ (-1L << MACHINE_BIT);//-1L ^ (-1L << 5)
